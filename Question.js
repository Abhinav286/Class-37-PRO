class Question {
    ...
    display(){
    this.title.html("Moon Question");
    this.title.position(350,0);

    this.question.html("Who Landed on the Moon First?");
    this.question.position(100,30);
    this.option1.html("1: Neil Armstrong");
    this.option1.position(150,60);
    this.option2.html("2: Edwin Buzz Aldrin");
    this.option2.position(150,100);
    this.option3.html("3: Both");
    this.option3.position(150,140);
    this.option4.html("4: No-one");
